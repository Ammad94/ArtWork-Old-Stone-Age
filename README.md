...
| File | Description |
|---|---|
| `assets/characters/hero_caveman/hero_caveman_idle_front_176x392.png` | Game-ready sprite: standing idle pose, front view. 176×392 px, 32-bit RGBA PNG, 72 DPI, fully transparent background, 0% margin (bbox flush to frame: top/bottom exact, left/right minimal aspect padding), anti-aliased edges, no outline / drop shadow / glow. |
...
- Size: 176 × 392 px (portrait), character centered, 0% margin (silhouette bbox flush to the frame; vertical axis binding, minimal transparent side padding from aspect fit)
...
- `tools/make_sprite.py` — reproducible pipeline that derives the game-ready
  ...
  176×392 frame at a configurable margin (default 0), premultiplied LANCZOS downscale, QA previews.
